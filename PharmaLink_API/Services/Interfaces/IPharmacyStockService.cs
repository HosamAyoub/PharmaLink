...
namespace PharmaLink_API.Services.Interfaces
{
    ...
    public interface IPharmacyStockService
    {
        ...
        ServiceResult<List<PharmacyProductDetailsDTO>> GetPharmacyStockByPharmacyID(int pharmacyId, int pageNumber, int pageSize, out int totalSize);
        ...
        ServiceResult<List<PharmacyProductDetailsDTO>> GetPharmacyStockByCategory(int pharmacyID, string category, int pageNumber, int pageSize);
