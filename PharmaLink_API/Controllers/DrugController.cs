...
namespace PharmaLink_API.Controllers
{
    ...
    public class DrugController : ControllerBase
    {
        ...
        /// <summary>
        /// Service interface for pharmacy-related business logic.
        /// </summary>
        ...
        public DrugController(IDrugRepository drugRepo, IPharmacyStockRepository pharmaStockRepo,IPharmacyService pharmaservice ,ApplicationDbContext _context , IMapper mapper)
        {
            this.DrugRepo = drugRepo;
            this.PharmaStockRepo = pharmaStockRepo;
            this._PharmaService = pharmaservice;
            Context = _context;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> GetAdminData()
        {
            ...
            foreach (var D in DrugRequests)
            {
                ...
                requests.Add(new DrugRequestDTO
                {
                    ...
                    DrugRequests = _mapper.Map<DrugDetailsDTO>(D)
                });
            }
            return Ok(new
            {
        ...
        //[Authorize(Roles = "Admin")]
        [HttpPut()]
        public async Task<IActionResult> Put([FromBody] DrugDetailsDTO EditedDrugDTO)
        {
            if (EditedDrugDTO == null) return NotFound();
